...
- `index.html` — single-page homepage (vanilla HTML/CSS, no build step)
- `assets/` — brand marks and favicons used by the homepage
- `CNAME` — custom domain configuration for GitHub Pages

## Editing

It's one HTML file. Edit it. Commit. GitHub Pages publishes on push to `main`.
